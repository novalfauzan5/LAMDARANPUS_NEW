...
function AdminHistoryGigi() {
  ...
  const DataPasienGigi =
    formik.values.reportDate !== ""
      ? users.filter((user) => user.poli === "Poli Gigi" && user.queue_date === formik.values.reportDate) : users.filter((user) => user.poli === "Poli Gigi");
    ...
    <div className="mb-[100px]">
      ...
      <div className="flex">
        ...
        <button
          ...
          type="button"
          onClick={() => navigate("/manage-queue-gigi")}
        >
      ...
      <div className="flex justify-end mx-20 mt-[40px]">
        ...
        <Button color={"success"} onClick={() => generatePDF(DataPasienGigi, "Poli Gigi")}>
          Cetak Laporan
        </Button>
      </div>
...
export default AdminHistoryGigi;
