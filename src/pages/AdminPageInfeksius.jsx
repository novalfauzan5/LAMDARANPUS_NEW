    ...
    <div className="mb-[100px]">
      ...
      <div className="flex">
        ...
        <button
          ...
          type="button"
          onClick={() => navigate("/histori-infeksius")}
        >
        ...
        <div className="w-[1370px] mt-[61px]">
          <Table>
            ...
            <Table.Body className="divide-y">
              {pasienInfeksius.length === 0 ? (
                <Table.Row>
                  <Table.Cell>
                    <p className="font-inter font-bold text-black">
                      Tidak ada Antrian pada Poli Infeksius
                    </p>
                  </Table.Cell>
                </Table.Row>
              ) : (
                pasienInfeksius.map((user) => (
                  <Table.Row
...
export default AdminPageInfeksius;
